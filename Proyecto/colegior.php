        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
              ...
              include('db.php');
              ?>
                <h1 style="text-align:center">Muestra Tabla de Colegios</h1>  
                ...
                <thead>
                  <tr>
                    ...
                    <?php foreach($conexion->query("SELECT * FROM formulario") as $row){?>
  
                          <tr>
                            <td><?php echo $row['id_formulario'] ?></td>
                            <td><?php echo $row['nombreinstitucion'] ?></td>
                            <td><?php echo $row['rector'] ?></td>
